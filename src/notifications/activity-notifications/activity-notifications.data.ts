import { ActivityNotification, ActivityType, BakerRewardsActivityNotification, BidMadeActivityNotification, BidOutbitedActivityNotification, BidReceivedActivityNotification, CollectiblePurchasedActivityNotification, CollectibleResoldActivityNotification, CollectibleSellOfferActivityNotification, CollectibleSoldActivityNotification, StatusType, TransactionActivityNotification } from "./activity-notifications.interface";

const transactionNotifications: Array<TransactionActivityNotification> = [
  {
    id: "1t",
...
const bakerNotifications: Array<BakerRewardsActivityNotification> = [
  {
    id: "1b",
...
const collectiblesSold: Array<CollectibleSoldActivityNotification> = [
  {
    id: "1cs",
    createdAt: "2020-01-02T00:00:00.000Z",
    status: StatusType.New,
...
const collectiblesPurchased: Array<CollectiblePurchasedActivityNotification> = [
  {
    id: "1cp",
...
const collectiblesResold: Array<CollectibleResoldActivityNotification> = [
  {
    id: "1cr",
    createdAt: "2020-01-02T00:00:00.000Z",
    status: StatusType.New,
...
const collectiblesOffers: Array<CollectibleSellOfferActivityNotification> = [
  {
    id: "1co",
    createdAt: "2020-01-02T00:00:00.000Z",
    status: StatusType.New,
...
const bidsMade: Array<BidMadeActivityNotification> = [
  {
    id: "1bm",
    createdAt: "2020-01-02T00:00:00.000Z",
    status: StatusType.New,
...
const bidsReceived: Array<BidReceivedActivityNotification> = [
  {
    id: "1br",
    createdAt: "2020-01-02T00:00:00.000Z",
    status: StatusType.New,
...
const bidsOutbidded: Array<BidOutbitedActivityNotification> = [
  {
    id: "1bm",
    createdAt: "2020-01-02T00:00:00.000Z",
    status: StatusType.New,
...
export const mockData: Array<ActivityNotification> = [
  ...transactionNotifications,
  ...bakerNotifications,
  ...collectiblesSold,
  ...collectiblesPurchased,
  ...collectiblesResold,
  ...collectiblesOffers,
  ...bidsMade,
  ...bidsReceived,
