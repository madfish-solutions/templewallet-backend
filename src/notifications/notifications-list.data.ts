...
const BANNERS_BUCKET_URL =
  'https://generic-objects.fra1.digitaloceanspaces.com/notification-icons';
...
export const MANDATORY_NOTIFICATIONS_LIST: Notification[] = [
  {
    id: 3,
    createdAt: '2022-12-16T10:00:00.000Z',
  ...
  },
  {
    ...
    description:
      'Thank you for choosing Temple wallet for all your Tezos related needs!',
    content: [
      'Welcome, traveler.\n',
      '\n',
      ...
      {
        text: 'knowledge base',
        url: 'https://madfish.crunch.help/temple-wallet',
      },
      ' and ',
      {
